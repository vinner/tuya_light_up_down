...
import { Utils, Button, TYText, Slider, IconFont, TimerPicker, TYFlatList, DatePicker, SwitchButton } from 'tuya-panel-kit';

const DEFAULT_LIST_THEME = {
  titleFontSize: 14,
  backIconColor: '#000',
  checkboxColor: '#FF4800',
};
...
const { convertX: cx, isIphoneX, isIos } = Utils.RatioUtils;
...
const {
  ...
  cellHeight: (props) => getTheme(props, 'popup.cellHeight', 56),
  cellBg: (props) => getTheme(props, 'popup.cellBg', '#fff'),
  cellFontColor: (props) => getTheme(props, 'popup.cellFontColor', 'rgba(0,0,0,0.9)'),
  cellFontSize: (props) => getTheme(props, 'popup.cellFontSize', 16),
  titleRadius: (props) => getTheme(props, 'popup.titleRadius', 16),
  titleHeight: (props) => getTheme(props, 'popup.titleHeight', 56),
  titleBg: (props) => getTheme(props, 'popup.titleBg', '#ffffff'),
  footerRadius: (props) => getTheme(props, 'popup.footerRadius', 0),
  bottomBg: (props) => getTheme(props, 'popup.bottomBg', '#f8f8f8'),
  lineColor: (props) => getTheme(props, 'popup.lineColor', 'rgba(0, 0, 0, 0.1)'),
  titleFontSize: (props) => getTheme(props, 'popup.titleFontSize', 14),
  titleFontColor: (props) => getTheme(props, 'popup.titleFontColor', 'rgba(0,0,0,0.9)'),
  cancelFontSize: (props) => getTheme(props, 'popup.cancelFontSize', 16),
  cancelFontColor: (props) => getTheme(props, 'popup.cancelFontColor', 'rgba(0,0,0,0.7)'),
  confirmFontSize: (props) => getTheme(props, 'popup.confirmFontSize', 16),
  confirmFontColor: (props) => getTheme(props, 'popup.confirmFontColor', '#FF4800'),
  subTitleFontColor: (props) => getTheme(props, 'popup.subTitleFontColor', 'rgba(0, 0, 0, .5)'),
  backIconColor: (props) => getTheme(props, 'popup.backIconColor', '#000'),
  pressColor: (props) => getTheme(props, 'popup.pressColor', '#E5E5E5'),
};
        ...
        return (
          ...
          >
            ...
            <TimerPicker
              ...
              style={[
                isIos && { height: cx(216), marginTop: cx(6) },
                !isIos && { height: cx(216), marginTop: cx(27), marginBottom: cx(26) },
                timerStyle,
              ]}
              amText={'am'}
              pmText={'pm'}
          ...
          <TYFlatList
            ItemSeparatorComponent={() => (
              <View style={{ backgroundColor: getTheme(listTheme, 'popup.cellBg') }}>
                <View
                  style={{
                    backgroundColor: '#dbdbdb', //getTheme(listTheme, 'popup.lineColor'),
                    marginLeft: cx(24),
                    marginRight: cx(24),
                    height: StyleSheet.hairlineWidth,
                  }}
